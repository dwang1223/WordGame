...
public class TestWord extends TestCase {
	public void testConstruction() {
		Word word = new Word(10, 10, "king", false, false);
	...
	public void testMove() {
		Word word = new Word(10, 10, "di", false, false);
	...
	public void testIntersect() {
		...
		Word other = new Word(20, 20, "wang", false, false);
	...
	public void testEqual() {
		Word word = new Word(10, 10, "di", false, false);
		Word other = new Word(10, 10, "di", false, false);
		Word other2 = new Word(10, 10, "wang", false, false);
		Word other3 = new Word(20, 10, "di", false, false);
